    ...
    >
      <div className={styles.markWrap}>
        ...
        >
          ...
          <path d="M4891 1268 c-122 -60 -221 -230 -221 -377 0 -75 23 -124 70 -148 93 -47 241 52 315 210 70 149 64 281 -15 322 -41 21 -98 19 -149 -7z m124 -8 c43 -48 -11 -276 -98 -413 -81 -125 -162 -142 -174 -36 -12 105 86 360 166 432 46 41 79 47 106 17z" style={{ animationDelay: "720ms" }} pathLength={1} />
